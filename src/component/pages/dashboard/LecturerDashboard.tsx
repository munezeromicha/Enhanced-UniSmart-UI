...
const ErrorFallback = ({ error, resetErrorBoundary }) => {
  return (
    <div className="p-4 bg-red-50 rounded-lg">
      <p className="text-red-600">Error generating QR code. Please try again.</p>
    </div>
  );
};
...
const LecturerDashboard = () => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-[#00628b] mb-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-200 p-6">
          <h2 className="text-xl font-bold text-[#00628b] mb-6 flex items-center">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full p-3 border-2 border-gray-200 rounded-lg appearance-none bg-white hover:border-[#00628b] focus:border-[#00628b] focus:ring-2 focus:ring-[#00628b]/20 transition-colors duration-200"
                >
        ...
        <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-200 p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-[#00628b] flex items-center">
              <BarChart2 className="w-6 h-6 mr-2" />
              Attendance Overview
            </h2>
            <button className="flex items-center space-x-2 text-[#00628b] hover:text-cyan-700 bg-cyan-50 px-4 py-2 rounded-lg transition-colors duration-200">
              <Download size={20} />
